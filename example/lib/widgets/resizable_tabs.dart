...
class _IndicatorPainter extends CustomPainter {
  ...
  bool shouldRepaint(_IndicatorPainter old) {
    return _needsPaint || controller != old.controller || indicator != old.indicator || tabKeys.length != old.tabKeys.length || (!_tabOffsetsEqual(_currentTabOffsets, old._currentTabOffsets)) || _currentTextDirection != old._currentTextDirection;
  }
}
...
class TabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize {
    return Size.fromHeight(30.dp + indicatorWeight);
  }
...
class _TabBarState extends State<TabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller.length == 0) {
      return Container(
        height: 30.dp + widget.indicatorWeight,
      );
    }
