...
public class RCFlutterEngine extends IRCRTCStatusReportListener implements MethodCallHandler {
        ...
        .joinRoom(
            ...
            new IRCRTCResultDataCallback<RCRTCRoom>() {
              ...
              public void onSuccess(RCRTCRoom rcrtcRoom) {
                ...
                roomMap.put(room.getId(), room);
                RCFlutterRequestResult<RCFlutterRoom> requestResult =
                    new RCFlutterRequestResult<RCFlutterRoom>(room, 0);
                UIThreadHandler.success(result, JSONObject.toJSON(requestResult).toString());
              }
              ...
              public void onFailed(RTCErrorCode rtcErrorCode) {
                ...
                RCFlutterRequestResult<String> requestResult =
                    new RCFlutterRequestResult<>(rtcErrorCode.getReason(), rtcErrorCode.getValue());
                UIThreadHandler.success(result, JSONObject.toJSON(requestResult).toString());
              }
            });
  }
  ...
  //    RCRTCRoomType roomType = type == 0 ? RCRTCRoomType.LIVE_AUDIO :
  // RCRTCRoomType.LIVE_AUDIO_VIDEO;
  //    RCRTCEngine.getInstance()
  //        .subscribeLiveStream(
  //            url,
  //            roomType,
  ...
  //                }
  //                UIThreadHandler.success(result, list);
  //              }
  //
  //              @Override
  //              public void onFailed(RTCErrorCode rtcErrorCode) {
