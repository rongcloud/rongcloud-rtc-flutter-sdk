...
import 'widgets/video_chat_settings.dart';
import 'widgets/video_chat_widgets.dart';

class VideoChatPage extends StatefulWidget {
  final bool _debug;

  VideoChatPage(this._debug);
...
//                        height: ScreenUtil().setHeight(300),
  ...
  Widget _fullScreenVideoView() {
    if (_streamOnFullScreen == null) {
      ...
      return RCRTCVideoView(
        ...
        onCreated: (view, id) => _setViewToStream(view, _streamOnFullScreen),
      );
    }
  }
  ...
  _setViewToStream(RCRTCVideoView view, RCRTCStream stream) {
    if (stream is RCRTCVideoOutputStream) {
      stream.setVideoView(view);
