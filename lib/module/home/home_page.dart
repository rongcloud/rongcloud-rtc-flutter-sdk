              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.0),
                    gradient: LinearGradient(
                      colors: [ColorConfig.defaultGradientStart, ColorConfig.defaultGradientEnd],
                      begin: const FractionalOffset(0.0, 0.0),
                      end: const FractionalOffset(1.0, 1.0),
                      stops: [0.0, 1.0],
                      tileMode: TileMode.clamp,
  ...
  Widget _buildStart(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(colors: [ColorConfig.defaultGradientEnd, ColorConfig.defaultGradientStart], begin: const FractionalOffset(0.2, 0.2), end: const FractionalOffset(1.0, 1.0), stops: [0.0, 1.0], tileMode: TileMode.clamp),
      ),
